...
# 15/02/2021 pyan3 'repo URL(https://github.com/user/project)' 'pattern(/**/*.py)' 
...
target_repo = current_wd + "/" + repository.split('/')[4] + pattern
...
execute_pyan = "pyan3 " + target_repo + " --uses --no-defines --colored --grouped --annotated  -f " + output_file + " --uses --no-defines --tgf"
print(execute_pyan)
